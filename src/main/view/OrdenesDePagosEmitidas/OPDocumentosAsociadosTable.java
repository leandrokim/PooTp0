...
public class OPDocumentosAsociadosTable extends AbstractModelTable<Documento.DTODocumento> {

    public OPDocumentosAsociadosTable(ArrayList<Documento.DTODocumento> lista, ArrayList<TableColumn> columnas) {
